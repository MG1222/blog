 ...
 */
final class Version20221215100752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD post_id_id INT DEFAULT NULL, DROP post_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD post_id INT NOT NULL, DROP post_id_id');
    }
}
